      ...
      const performFieldValidation = (field: string, val: string): boolean => {
          ...
          switch (fieldCasted) {
              ...
              case ReqFields.hgt:
                  ...
                  var matchRes: RegExpMatchArray = val.match(re);
                  if (matchRes) {
                      if (matchRes[2] === "cm") {
...
*** Part 1
    #+BEGIN_SRC typescript
      ...
      console.log(`Answer: ${sumOfAnswers}`);
    #+END_SRC
